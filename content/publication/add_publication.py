...
if __name__ == "__main__":
    ...
    #     "Hui Jiang, Ziyao Lu, Fandong Meng, Chulun Zhou, Jie Zhou, Degen Huang and Jinsong Su*. 2022. Towards Robust k-Nearest-Neighbor Machine Translation. In Proc. of EMNLP 2022. (CCF-B类)// 文本机器翻译",
